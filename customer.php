        ...
        <div class="row" >
            <div class="col-md-2" id="menu">
                <ul class="nav nav-pills nav-stacked text-center">
                    ...
                    <li>
                        <a href="customer.php" style="color:#ff6e05;"><i class="fa fa-user"></i> Customer</a>
                    </li>
                    <li>
                                    ...
                                    <div class='panel panel-info wow zoomIn'>
                                        ...
                                        <div class='panel-heading'>
                                           <span style='color:red'>".$row['name']."</span>
                                            <a href='customerDetail.php?id=".$row['cid']."' type='button' class='btn btn-success btn-xs' style='float: right'>View</a>
                                        </div>
                                    </div>
                                </div>
