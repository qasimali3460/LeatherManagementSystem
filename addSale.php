   ...
   ?>	
	<div class="container-fluid">
        <div class="row" >
            ...
            <div class="col-md-10 wow fadeInUp" style="">
                <div class="container-fluid" style="background: rgba(100,100,100,1);padding-top: 30px; background-image: url('img/form4.jpg');background-position: center;background-size: 100% auto; ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" style="font-size: 15px;" for="name">Select Customer</label>
                                            <div class="col-sm-8">
                                              <input id="employee" name="employee" list="allNames" class="form-control" placeholder="Enter name of Customer" />
                                              <datalist id="allNames">
                                                  <?php
                                                    $query=mysqli_query($con,"select * from customer where  status='0'");
   ...
   <script type="text/javascript">
        ...
        $("#confirm").click(function(){
          ...
          $.ajax({
                    ...
                    success:function(data){
                      var order_id=data;
                      var win = window.open("salePrint.php?order_id="+order_id, '_blank');
                      win.focus();
