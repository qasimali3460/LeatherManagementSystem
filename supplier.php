            ...
            <div class="col-md-10" style="" id="pnl">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body" style="background-color: #EEE6C1;border:1px solid #f2dc7d; ">
                        ...
                        <p class="text-center text-Success" style="font-size:30px;color:green;">Supplier List
                            <a class="btn btn-danger pull-right" href="NewSupplier.php">Add New</a>
                        </p>
                        </div>
                                    ...
                                    <div class='panel panel-info wow zoomIn'>
                                        ...
                                        <div class='panel-heading'>
                                           <span style='color:red'>".$row['name']."</span>
                                            <a href='supplierDetail.php?id=".$row['cid']."' type='button' class='btn btn-success btn-xs' style='float: right'>View</a>
                                        </div>
                                    </div>
                                </div>
