        ...
        <div class="row" >
            <div class="col-md-2" id="menu" style="" >
                <ul class="nav nav-pills nav-stacked text-center animated fadeIn">
                    ...
                    <li><a href="purchases.php" style="color:#ff6e05;"><i class="fa fa-cart-arrow-down"></i> Purchases</a></li>
                    <br><br>
                    <li class="active" >
                        <a href="#" >
                                   ...
                                   while($row=mysqli_fetch_array($query))
                                   {
                                        ...
                                        <tr >
                                            <td style='border:none;'>
                                             <a href='purchasePrint.php?order_id=".$gold."' id='edit' target='_blank' type='button' class='btn btn-lg btn-primary' >Print</a>
