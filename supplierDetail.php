        ...
        <div class="row" >
            <div class="col-md-2" id="menu" style="background-color: rd">
                <ul class="nav nav-pills nav-stacked text-center">
                    ...
                    <li>
                        <a href="supplier.php" style="color:#ff6e05;"><i class="fa fa-user"></i> Supplier</a>
                    </li>
                    <li>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <div class="table-responsive">
                                                            ...
                                                            <tbody>
                                                                <?php
                                    $query=mysqli_query($con,"select * from supplier where cid='$id'");
                                    ...
                                    {
                                        echo "<p class='text text-danger text-xsm' style='color:#5a08a3;font-size:30px;'>No Supplier Account found</p>";
                                    }
                                                        ...
                                                        <div class="panel panel-primary ">
                                                            <div class="panel-heading text-center" style="background-color: #ff5a00;">
                                                                <p style="font-size: 30px">     Total Balance : 
                                                                    <span><?php
                                                                        $qur=mysqli_query($con,"select * from supplier where cid='$id' ");
                                                    ...
                                                    <div class="col-md-12">
                                                        <?php
															if(true)
															  ...
															  $query = mysqli_query($con, "SELECT * FROM purchase where p_id='$id'  ORDER BY id DESC ");
																						   ...
																						   while($row=mysqli_fetch_array($query))
																						   {
																								...
																								<tr >
																									<td style='border:none;'>
																									 <a href='purchasePrint.php?order_id=".$gold."' id='edit' target='_blank' type='button' class='btn btn-primary' ><span class='glyphicon glyphicon-print'></span> Print</a>
																									</td>
																									<td style='border:none;'>
																							  ...
																							  $previous=$current;
																								...
																								<tr >
																									<td style='border:none;'>
																									 <a href='purchasePrint.php?order_id=".$gold."' id='edit' target='_blank' type='button' class='btn btn-primary' ><span class='glyphicon glyphicon-print'></span> Print</a></td>
																									<td style='border:none;'>
