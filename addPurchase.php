  ...
  <div class="container-fluid">
        <div class="row" >
            ...
            <div class="col-md-10 wow jackInTheBox" style="">
                <div class="container-fluid" style="background: rgba(100,100,100,1);padding-top: 30px; background-image: url('img/form11.jpg');background-position:center; background-size: 100% auto;background-repeat:  ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              ...
                                              <datalist id="allNames">
                                                  <?php
                                                    $query=mysqli_query($con,"select * from supplier where  status='0'");
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
       $(document).ready(function(){
          ...
          $('#addPurchase').attr("class","navactive");
